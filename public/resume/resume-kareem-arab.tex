...
\begin{document}
    ...
    \begin{longtable}{@{}>{\raggedleft}p{0.25\linewidth}
        ...
        \textbf{frameworks and technologies}
            & \textbf{\textsc{XCode --- iOS ---TensorFlow --- AWS Lambda/Serverless --- REST --- Git --- CI/CD --- Google Cloud Functions --- Linux --- Ionic (Angular) --- Firebase --- Firestore --- Parse --- Realm --- NextJS --- DynamoDB --- Vercel --- MathJax --- Latex}}\\ [3.5em]
        ...
        \textbf{projects}
            ...
            & - Private events iOS app - alpha release soon. Built using \textbf{Swift}, \textbf{Firebase}, \textbf{Google Cloud Functions} and \textbf{Realm DB}\\ [2em]
