...
\begin{document}
    ...
    \begin{longtable}{@{}>{\raggedleft}p{0.25\linewidth}
        ...
        \textbf{work experience}
            ...
            & - Involved in designing, building and integrating \textbf{Multi-Factor Authentication} into multiple production systems serving millions of people. \\
		    & -  Helped develop internal tools to help developers in test-driven development \\ [1em]
