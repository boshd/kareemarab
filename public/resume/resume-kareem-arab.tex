...
\begin{document}
    ...
    \begin{longtable}{@{}>{\raggedleft}p{0.25\linewidth}
        ...
        \textbf{frameworks and technologies}
            & \textbf{\textsc{Serverless (AWS Lambda/GCP Functions) --- GCP --- AWS --- Azure --- K8s --- Helm --- Docker --- Terraform --- Vault --- CI/CD (Github Actions, Jenkins, Spinnakr) --- iOS --- TensorFlow --- MySQL --- Redis --- DynamoDB --- Ionic (Angular) --- Firebase --- Realm --- NextJS --- Latex}}\\ [5em]
