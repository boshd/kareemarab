...
\begin{document}
    ...
    \begin{longtable}{@{}>{\raggedleft}p{0.25\linewidth}
        ...
        \textbf{frameworks and technologies}
            & \textbf{\textsc{iOS, iPadOS, XCode, Realm, Serverless (AWS Lambda/GCP Functions) --- GCP --- AWS --- K8s --- Helm --- Docker --- Vault --- CI/CD (XCode Cloud, Github Actions, Jenkins, Spinnakr) --- TensorFlow --- SpringBoot --- MySQL --- Redis --- DynamoDB --- Ionic --- Firebase --- Rancher --- Splunk --- Latex}}\\ [5em]

        \textbf{work experience}
            & \textbf{\textsc{Amadeus}} & \textit{Mar 2021 - present}\\
            & \textit{Full Stack Engineer} \\
            & - Involved in designing, building and integrating \textbf{Multi-Factor Authentication (MFA)} into multiple production systems \\
            & - Invloved in planning and execution of a multi-service deployment to Rancher \\
            & - Resposibility over critical system components \& onboarding of new engineers \\
		    & - Aided in the design, development and testing of internal tools (user-management, code-review listing, etc.) that help other developers in their development proocess \\ [2em]

            & \textbf{\textsc{Neurovine}} & \textit{Apr 2019 - Feb 2021}\\
            & \textit{Software Engineer} \\
            & - Built \textbf{APIs} w/ \textbf{AWS Lambda} that provide functionality to multiple apps \\
		    & - Helped develop a consumer mobile app \& research portal using the \textbf{Ionic} \\
		    & - Collaborated w/ Data Science team to build a \textbf{Python} \textbf{real-time} EEG analysis system \\
		    & - Helped implement \textbf{HIPPA} requirements across all our systems \\ [1em]
        ...
        \textbf{projects}
            ...
            & - Private events iOS app - beta. Built using \textbf{Swift}, \textbf{Firebase}, \textbf{Google Cloud Functions}, \textbf{Cloud Scheduler}  and \textbf{Realm DB}\\ [2em]
