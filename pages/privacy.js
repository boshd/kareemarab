		...
		<>
			<SecondaryLayout>
				<article className="post-container">
					...
					<p>
						Kareem Arab built the Handshake app as a Free app. This
						SERVICE is provided by Kareem Arab at no cost and is
					...
					<p>
						...
						policy. The Personal Information that I collect is used
						for providing and improving the Service. I will not use
					...
					<p>
						...
						accessible at Handshake unless otherwise defined in this
						Privacy Policy.
					</p>{' '}
					<p>
					...
					<p>
						...
						location, phone number, display name . The information
						that I request will be retained on your device and is
					...
					<p>
						...
						information, please contact me so that I will be able to
